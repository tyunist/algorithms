# --------------There are some mistakes here in sense() function
# USER INSTRUCTIONS
#
...
class robot:
    ...
    def sense(self): #do not change the name of this function
        Z = []
        Z.append(atan2((landmarks[0][0] - self.y),(landmarks[0][1] - self.x)))
        Z.append(atan2((landmarks[1][0] - self.y),(landmarks[1][1] - self.x)))
        Z.append(atan2((landmarks[2][0] - self.y),(landmarks[2][1] - self.x)))
        Z.append(atan2((landmarks[3][0] - self.y),(landmarks[3][1] - self.x)))
        # ENTER CODE HERE
